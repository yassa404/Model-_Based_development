...
typedef struct P_EnabledSubsystem_untitled_T_ P_EnabledSubsystem_untitled_T;

/* Parameters for system: '<Root>/If Action Subsystem' */
typedef struct P_IfActionSubsystem_untitled_T_ P_IfActionSubsystem_untitled_T;
