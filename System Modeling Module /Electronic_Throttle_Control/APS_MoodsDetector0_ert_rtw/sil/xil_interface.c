 ...
 *
 * SIL generated interface for code: "APS_MoodsDetector0"
 *
 */
...
static int32_T output_1_cData_1_nonaddr_io;
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    APS_MoodsDetector0_initialize();

    {
      output_1_cData_1_nonaddr_io = ( int32_T ) rtY.APP_stOperationMode;
    }
  } else {
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtU.APP_bSensor_1_Failure);
        ...
        {
          void * dataAddress = (void *) &(rtU.APP_bSensor_2_Failure);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (boolean_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(rtU.APP_bCoherency_Failure);
