...
## 
## Makefile     : PID0.mk
## Generated on : Fri Jul 19 09:58:50 2024
## Final product: ./PID0.exe
...
START_DIR                 = D:/course/MBD/system_modeling_7/labs/PID_Controller
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/PID0_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/PID0_ert_rtw/sil -I$(START_DIR)/PID0_ert_rtw/coderassumptions -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc
...
DEFINES_STANDARD = -DMODEL=PID0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ../PID0.obj

LIBS = $(START_DIR)/PID0_ert_rtw/coderassumptions/lib/PID0_ca.lib $(MATLAB_ROOT)/sys/lcc64/lcc64/lib64/wsock32.lib
...
xil_interface.obj : $(START_DIR)/PID0_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


sil_main.obj : $(START_DIR)/PID0_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
